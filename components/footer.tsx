        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              <li>Edición XXXI Libros Electrónicos febrero 2025</li>
              <li>Edición XXXII Libros Electrónicos marzo 2025</li>
            </ul>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4">Revista electrónica</h4>
            <p>Vol 7. Num 1. 2025</p>
          </div>
